...
?>
    <div class="container  mb-5  position-relative">
        <h2 class="text-center text-primary">Delivered Orders</h2>
        <div class="row justify-content-center">
            <div class="col-lg-8 " style="margin-top:20px;margin-bottom:50px">
                <?php if (mysqli_num_rows($res) > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <div class="alert alert-warning text-center">No Orders Assigned</div>
                <?php endif; ?>
            </div>
        </div>
