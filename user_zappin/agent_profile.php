...
$sql = "SELECT fullname, mobile, email, address, pincode, photo,password FROM agent WHERE userid = ?";
...
<div class="container " style="margin-top:80px">
    <div class="card mx-auto shadow-lg border-0" style="max-width: 500px;">
        <div class="card-body text-center">
            ...
            <a href="agent_index.php"  class="btn btn-secondary w-100 mt-3">Back to Home</a>
        </div>
    </div>
</div>
